...
class BWPSeleniumWebDriverTestCase(LiveServerTestCase):
    ...
    def setUpClass(cls):
        ...
        super(BWPSeleniumWebDriverTestCase, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(BWPSeleniumWebDriverTestCase, cls).tearDownClass()
    ...
    def bwp_login(self, username, password, login_url='/bwp/'):
        """
        Helper function to log into the bwp.
        """
